    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if ((auth()->user()->role === 'admin') | (auth()->user()->role === 'kominfo'))
                    <li class="nav-item">
                ...
                @endif
                <li
                    class="nav-item {{ Request::is('tabel/index', 'tabel/create', 'tabel/deletedList') ? 'menu-open' : '' }}">
                    <a href=""
                        class="nav-link {{ Request::is('tabel/index', 'tabel/create', 'tabel/deletedList') ? 'active' : '' }}">
