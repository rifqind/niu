<x-niu-layout>
    ...
    <div class="container-fluid">
        ...
        @endif
        <table class="table table-hover table-bordered table-sorted" id="tabel-baris">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text-left search-header tabel-width-20" ><input type="text" class="search-input form-control"></td>
                    <td class="text-left search-header tabel-width-20" ><input type="text" class="search-input form-control"></td>
