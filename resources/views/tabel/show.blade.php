<x-niu-layout>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="text-bold">{{ $tabel->judul_tabel }}
                    <h4 class="my-0">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                $(".save-send").on("click", function(e) {
                    ...
                    setTimeout(() => {
                        ...
                        handleSaveTable(button, buttonInitialText, decisions);
                    }, 1500);
                })

            })

            const handleSaveTable = function(element, buttonInitialText, decisions) {
