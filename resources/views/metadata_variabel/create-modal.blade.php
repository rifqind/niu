            ...
            <div class="modal-body">
                <form action="{{ route('metavar.update') }}" method="post" id="form-update">
                    ...
                    <div class="form-group">
                        ...
                        <label for="r101">Nama Variabel</label>
                        <input class="form-control mb-3" id="show-r101" name="r101"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label for="">Apakah yakin akan menghapus metadata variabel : <span
                        id="judul-deleted"></span></label>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Tutup</button>
...
<div class="modal fade" id="downloadModal" tabindex="-1" role="dialog" aria-labelledby="downloadModal"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Tutup</button>
                <button id="downloadMetadataVariabel" type="submit"
                    class="btn btn-sm bg-success-fordone">Download</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="masterModal" role="dialog" aria-labelledby="masterModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="masterModalTitle">Master Metadata Variabel</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <label for="">Master Metadata Variabel : <span id="judul-deleted"></span></label>
                <select name="" id="master-select" class="form-control row-select">
                    <option value="{{ Illuminate\Support\Facades\Crypt::encrypt(0) }}">Tidak Ada/Tidak Menggunakan Master</option>
                    @foreach ($master_metavar as $item)
                        <option value="{{ Illuminate\Support\Facades\Crypt::encrypt($item->id) }}"> {{ $item->r101 }}
                        </option>
                    @endforeach
                </select>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Tutup</button>
                <button id="open-modal-create" class="btn btn-sm bg-success-fordone">Submit</button>
            </div>
        </div>
    </div>
</div>
