<x-niu-layout>
    ...
    <div class="container-fluid">
        <div class="row justify-content-between mb-2">
            <div class="ml-2 h4 mb-2">
                Daftar Kolom
            </div>
            <div class="ml-auto mr-2">
                <a href="{{ route('column.create') }}" class="btn bg-info-fordone"><i class="fa-solid fa-plus"></i>
                    Tambah Kolom</a>
            </div>
        </div>
        @if (session('success'))
        ...
        @endif
        <table class="table table-hover table-bordered table-sorted" id="tabel-kolom">
            <thead>
